...
import { HeadToHead, HeadToHeadMatch, useHeadToHeadMatches, useWikipediaByCountry, useWikipediaByFootballTeam } from '../../../../../SoccerHooks/useWikipedia';
...
export const FifaTeam: React.FunctionComponent<FifaTeamProps> = (props) => {
    ...
    const [sortAscendeing, setSortAscending] = useState({ isSort: false, columnName: '' });
    ...
    const { teamNationalLogo, teamNationalFlag } = useWikipediaByCountry(props.nationName);
    ...
    return (
        <>
            ...
            {
                !isAnimation && <div className='select-opponent-team'>
                    <button onClick={() => {
            ...
            }
            {
                selectedOpponent.length === 0 ?
                   ( !showSelection && <table className='head-to-head-info'>
                        <thead>
                            <tr style={{ gridTemplateColumns: startSelection ? '1fr 6fr 2fr 2fr 2fr 2fr 2fr 2fr 2fr' : '3fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr' }}>
                                ...
                                {columns.map(c => <th onClick={() => setSortAscending({ isSort: !sortAscendeing.isSort, columnName: c })}>{c}</th>)}
                            </tr>
                        </thead>
                        <tbody>
                            {
...
export const HeadToHeadHeadSingleResult: React.FunctionComponent<HeadToHeadSingleResultProps> = (props: HeadToHeadSingleResultProps) => {
    ...
    const { isAnimation, setAnimation, nationName, teamNationalFlag, headToHeadRecords, opponentNationName } = props;
    ...
    return (
        <>
            ...
            <div className='common-head-to-head total-count'>
                ...
                <div className='head-to-head-matches' style={{ height: '330px', overflowY: 'scroll' }}>
...
export const HeadToHeadHeaderMatches: React.FunctionComponent<HeadToHeadMatchesProps> = (props: HeadToHeadMatchesProps) => {
    ...
    const { headToHeadMatches, isAnimation, matchIndex, setAnimation } = props;
        ...
        <>
            {
                !isAnimation ?
                    <table className='head-to-head-matches-table'>
                       ...
                       ( (matchIndex < headToHeadMatches.length) ? <div className='head-to-head-matches-animation' style={{ height: '300px', backgroundColor: 'yellow' }}>
                            <div>
                        ...
                        <div className='head-to-head-matches-animation' style={{ height: '300px', backgroundColor: 'yellow' }}>
                            <h1>{'The End'}</h1>
...
export const HeadToHeadHeadSelectedResult: React.FunctionComponent<HeadToHeadSelectedResultProps> = (props: HeadToHeadSelectedResultProps) => {
    ...
    const { nationName, opponentNationName, selectedHeadToHeadRecord, teamNationalFlag } = props;
    ...
    return (
        <>
            ...
            <div className='common-head-to-head total-count'>
                ...
                <div className='extra-records' style={{ height: '330px', overflowY: 'scroll' }}>
                    <div>
